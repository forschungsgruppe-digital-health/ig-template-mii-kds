# Preview Model - MII KDS IG Template — Preview v1.0.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://github.com/medizininformatik-initiative/ig-template-mii-kds/StructureDefinition/preview-model | *Version*:1.0.0 |
...
```json
{
  ...
  "title" : "Preview Model",
  "status" : "draft",
  "date" : "2026-08-14T05:21:35+00:00",
