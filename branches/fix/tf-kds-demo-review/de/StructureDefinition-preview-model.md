# Preview Model - MII KDS IG Template — Preview v1.1.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://github.com/medizininformatik-initiative/ig-template-mii-kds/StructureDefinition/preview-model | *Version*:1.1.0 |
...
```json
{
  ...
  "title" : "Preview Model",
  "status" : "draft",
  "date" : "2026-08-14T09:27:09+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
