# Preview Model - MII KDS IG Template — Preview v1.3.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://github.com/medizininformatik-initiative/ig-template-mii-kds/StructureDefinition/preview-model | *Version*:1.3.0 |
| Draft Stand: 2026-08-16 | *Maschinenlesbarer Name*:PreviewModel |
...
```json
{
  ...
  "title" : "Preview Model",
  "status" : "draft",
  "date" : "2026-08-16T13:36:26+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
