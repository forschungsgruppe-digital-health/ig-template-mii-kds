# Preview Model - MII KDS IG Template — Preview v0.5.1
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://github.com/medizininformatik-initiative/ig-template-mii-kds/StructureDefinition/preview-model | *Version*:0.5.1 |
| Draft Stand: 2026-08-06 | *Maschinenlesbarer Name*:PreviewModel |
...
```json
{
  ...
  "title" : "Preview Model",
  "status" : "draft",
  "date" : "2026-08-06T07:56:58+00:00",
