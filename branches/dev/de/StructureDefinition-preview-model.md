# Preview Model - MII KDS IG Template — Preview v1.3.1
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://github.com/medizininformatik-initiative/ig-template-mii-kds/StructureDefinition/preview-model | *Version*:1.3.1 |
| Draft Stand: 2026-08-20 | *Maschinenlesbarer Name*:PreviewModel |
...
```json
{
  ...
  "title" : "Preview Model",
  "status" : "draft",
  "date" : "2026-08-20T09:48:22+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
