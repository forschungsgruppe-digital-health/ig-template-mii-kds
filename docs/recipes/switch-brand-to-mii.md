...
| Legal/branding review asks about the NUM-DIZ logos | The NUM/NUM-DIZ logos are third-party brand assets (both combos reproduce official NUM-DIZ artwork) — and as the default they ship in every rendering that does not switch to MII | See `docs/styleguide.md` §10 — NUM-DIZ consent is pending, tracked in issue [#110](../../../../issues/110); switching to MII removes them from the build output |
